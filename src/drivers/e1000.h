...
static inline void e1000_write_reg(volatile void *addr, uint32_t reg, uint32_t val)
{
...
static inline void e1000_write_reg_array(volatile void *addr, uint32_t reg, uint32_t offset, uint32_t val)
{
	writel(val, (uint8_t *)addr + reg + (offset << 2));
}

static inline uint32_t e1000_read_reg_array(volatile void *addr, uint32_t reg, uint32_t offset)
{
